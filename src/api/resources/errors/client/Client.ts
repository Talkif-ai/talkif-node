...
/**
 * Error code catalog for API documentation
 */
export class ErrorsClient {
    ...
    ): core.HttpResponsePromise<Talkif.ErrorCatalogResponse> {
        return core.HttpResponsePromise.fromPromise(this.__errorCatalog(requestOptions));
    }

    private async __errorCatalog(
        requestOptions?: ErrorsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Talkif.ErrorCatalogResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Talkif.ErrorCatalogResponse, rawResponse: _response.rawResponse };
        }
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/api/v1/errors");
    }
}
